...
int PQCLEAN_DILITHIUM3_CLEAN_crypto_sign_keypair(uint8_t *pk, uint8_t *sk) {
    ...
    return PQCLEAN_DILITHIUM3_CLEAN_crypto_sign_keypair_det(coins, pk, sk);
}

/*************************************************
* Name:        PQCLEAN_DILITHIUM3_CLEAN_crypto_sign_keypair_det
*
* Description: Generates public and private key.
*
...
* Returns 0 (success)
**************************************************/
int PQCLEAN_DILITHIUM3_CLEAN_crypto_sign_keypair_det(uint8_t *coins, uint8_t *pk, uint8_t *sk) {
